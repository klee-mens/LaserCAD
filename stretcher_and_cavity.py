...
roundtrip=100
centerlamda = 1030E-6-50E-6
C_radius = 8000
# StripeM_shift = 0.1185
StripeM_shift = 0
mat1 = cavity_and_stretcher(C_radius=C_radius,vertical_mat=True,roundtrip=roundtrip,centerlamda=centerlamda,s_shift=StripeM_shift)
if roundtrip<10:
