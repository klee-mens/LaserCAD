...
from LaserCAD.basic_optics import Mirror,Beam,Cylindrical_Mirror,Curved_Mirror,Ray
from LaserCAD.basic_optics import Intersection_plane,Cylindrical_Mirror1, Composition, Grating
...
def cavity_and_stretcher(C_radius = 8000,vertical_mat=True,want_to_draw=True,roundtrip=1,centerlamda=1030e-9*1e3,s_shift=0,ls="CR"):
  ...
  if vertical_mat:
    ...
    # Concav3 = Cylindrical_Mirror1(radius=np.sqrt(Radius**2-(h_StripeM/2 + safety_to_StripeM + periscope_distance)**2), 
    #                               name="Concav_Mirror")
    # Concav4 = Cylindrical_Mirror1(radius=np.sqrt(Radius**2-(h_StripeM/2 + safety_to_StripeM + periscope_distance)**2), 
    #                               name="Concav_Mirror")
    ...
    # Concav3 = Cylindrical_Mirror(radius=np.sqrt(Radius**2-(h_StripeM/2 + safety_to_StripeM + periscope_distance)**2), 
    #                              name="Concav_Mirror")
    # Concav4 = Cylindrical_Mirror(radius=np.sqrt(Radius**2-(h_StripeM/2 + safety_to_StripeM + periscope_distance)**2), 
    #                              name="Concav_Mirror")
  ...
  if Comp._lightsource == centerray:
    ...
    # fig.savefig(os.path.join("C:/Users/12816/Desktop/research/Stretcher and Cavity1/another ip.pos/lsR=0.25",fig_name), 
...
#                             roundtrip=roundtrip,centerlamda=centerlamda,s_shift=StripeM_shift,ls=ls)
# print(mat1)
