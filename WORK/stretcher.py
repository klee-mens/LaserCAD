...
def small_shift_finden(Concav_shift=[0,0,0,0]):
  ...
  Concav1.pos = (Radius/2-np.sqrt(((Radius/2)**2)-(periscope_distance/2)**2),
  ...
  Concav1.pos = Concav1.pos+(Concav_shift[0])*Concav1.normal
  Concav1.draw_dict["mount_type"] = "dont_draw"
  
  Concav2.pos = (Radius/2-np.sqrt(((Radius/2)**2)-(periscope_distance/2)**2), 
                 0, half_height_middle)
  ...
  Concav2.pos = Concav2.pos+(Concav_shift[1])*Concav2.normal
  
  Concav3.pos = (Radius/2-np.sqrt(((Radius/2)**2)-(periscope_distance/2)**2), 
  ...
  Concav3.pos = Concav3.pos+(Concav_shift[2])*Concav3.normal
  
  Concav4.pos = (Radius/2-np.sqrt(((Radius/2)**2)-(periscope_distance/2)**2), 
                 0, -half_height_middle - periscope_distance)
  ...
  Concav4.pos = Concav4.pos+(Concav_shift[3])*Concav4.normal
  ray0 = Ray()
