# -*- coding: utf-8 -*-
"""
Created on Mon Jul 15 15:32:07 2024
...
from LaserCAD.basic_optics import Curved_Mirror, Composition,Rainbow
...
RB = Rainbow(separation=1,ray_count=11,wavelength_range=(2300E-6,2500E-6))
RB.draw()
