...
from LaserCAD.basic_optics.mount import KM100C, Post
...
# cyl.set_mount(KM100C(height=cyl.height, width=cyl.aperture))
...
cyl2.pos += (0, 100, 0)
cyl2.set_mount(KM100C_flipped(height=cyl2.height, width=cyl2.aperture))
